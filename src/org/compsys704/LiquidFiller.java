...
//		this.setPreferredSize(new Dimension(200, 300));
		panel = new Canvas_LiquidFiller();
		panel.setPreferredSize(new Dimension(168,232));
		panel.setBackground(Color.WHITE);
		JButton enable = new JButton("enable");
		enable.addActionListener(new SignalClient(Ports.PORT_LOADER_PLANT, Ports.ENABLE_SIGNAL));
		JButton request = new JButton("request");
		request.addActionListener(new SignalClient(Ports.LIQUIDFILLER_PORT_LOADER_CONTROLLER, Ports.LIQUIDFILLER_REQUEST_SIGNAL));
...
//		this.add(pan3,c);
	...
	public static void main(String[] args) {
		...
		SignalServer<LoaderVizWorker> server = new SignalServer<LoaderVizWorker>(Ports.LIQUIDFILLER_PORT_LOADER_VIZ, LoaderVizWorker.class);
