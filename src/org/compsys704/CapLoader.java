...
//		this.setPreferredSize(new Dimension(200, 300));
		...
		enable.addActionListener(new SignalClient(Ports.PORT_LOADER_PLANT, Ports.CapLoader_ENABLE_SIGNAL));
		JButton request = new JButton("request");
		request.addActionListener(new SignalClient(Ports.CapLoader_PORT_LOADER_CONTROLLER, Ports.CapLoader_REQUEST_SIGNAL));
...
//		pan2.add(pr);
	...
	public static void main(String[] args) {
		...
		SignalServer<LoaderVizWorker> server = new SignalServer<LoaderVizWorker>(Ports.CapLoader_PORT_LOADER_VIZ, LoaderVizWorker.class);
